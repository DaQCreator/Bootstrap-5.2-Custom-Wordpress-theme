    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="cat-header-text small">
          <h1 class="fs-4 fw-600">Oferta DaQCreator+</h1>
          <p>Zapraszam do przeglądu poniższej oferty stron internetowych i usług.</p>
          ...
          <a href="<?php the_permalink(); ?>" class="list-group-item list-group-item-action small glass-bg">
            <div class="row align-items-center">
              ...
              <div class="col-lg-8 col-md-8">
                ...
                <p><span class="badge bg-animated-custom text-white me-1">Cena od: <strong><?php echo the_field('cena_minimalna'); ?></strong> PLN netto</span><span class="badge bg-animated-custom text-white">Czas realizacji: <strong><?php echo the_field('czas_wykonania'); ?></strong> Dni</span></p>
