    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-6">
        <div class="page-title-heading small">
          ...
          <p><span class="badge glass-bg text-custom-main"><?php the_time('F jS, Y'); ?></span> by <?php the_author_posts_link(); ?></p>
        </div>
      </div>
      <div class="col-lg-6 col-md-6">
      <?php 
...
<!-- Custom Page Content -->
<section class="page-contents border-top pt-5 pb-5">
          <div class="container">
            <div class="row">
              <div class="col-lg-9 col-md-9">
                <article class="main-content small">
                  <?php the_content(); ?>
                  <div class="alert glass-bg text-custom-main border" role="alert">
                    <p class="postmetadata m-0"><?php _e( 'Kategoria:' ); ?> <?php the_category( ', ' ); ?></p>

                    <?php the_tags('#Hashtag: ',', '); ?>
                  </div>
